...
async function internalFetch(
  ...
  try {
    ...
    res.username =
      obj.actions[0].openPopupAction.popup.multiPageMenuRenderer.header.activeAccountHeaderRenderer.accountName.runs[0].text;
    res.pbThumbnailUrl =
      obj.actions[0].openPopupAction.popup.multiPageMenuRenderer.header.activeAccountHeaderRenderer.accountPhoto.thumbnails.url;
  } catch (error) {
